...
| `packages/core/src/core/step.ts` | § Step: a worker paired with a validator, always. `stepOutput`, `stepDef`, `StepDef`, `Attempt`, `StepResult`, `journalKey`, `runStep` and its six guardrails. |
